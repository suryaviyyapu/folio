...
export const metadata: Metadata = {
  title: "Blog | Surya Viyyapu",
  metadataBase: new URL("https://suryaviyyapu.com/blog"),
  description: "Read latest stories from Surya Viyyapu's Blog",
  openGraph: {
    title: "Blog | Surya Viyyapu",
    url: "https://suryaviyyapu.com/blog",
    description: "Read latest stories from Surya Viyyapu's Blog",
    images:
